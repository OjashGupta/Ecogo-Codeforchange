...
import '../ui_view/analysis_view.dart';
import '../ui_view/title_view.dart';

class MyDiaryScreen extends StatefulWidget {
  const MyDiaryScreen(
      {Key? key, this.animationController, required this.prodName})
      : super(key: key);
...
class MyDiaryScreenState extends State<MyDiaryScreen>
  ...
  void addAllListData() {
    ...
    listViews.add(
      TitleView(
        titleTxt: widget.prodName, //textController.text.toLowerCase(),
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Column(
                              children: [
                                Image.asset(
                                    "assets/app/financial-growth-analysis.png",
                                    height: 36),
                                SizedBox(height: 8,)
                              ],
                            ),
